...
public class NewsFavAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewsFavAdapter(Context context, ArrayList<Post> items, RecyclerView recyclerView) {
