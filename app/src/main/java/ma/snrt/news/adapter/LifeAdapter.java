...
public class LifeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LifeAdapter(Context context, ArrayList<Post> items, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup,
                                                      int viewType) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.life_item_layout, viewGroup, false);
