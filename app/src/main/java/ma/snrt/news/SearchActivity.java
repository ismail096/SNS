...
public class SearchActivity extends AppCompatActivity {
    ...
    NewsVidAdapter allAdapter;
    NewsFavAdapter newsAdapter;
    Videos2Adapter videosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsBtn = findViewById(R.id.search_news_btn);
        videoBtn = findViewById(R.id.search_video_btn);
        allBtn = findViewById(R.id.search_all_btn);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.search_all_btn:
                        selectAllMode();
                        break;
                    case R.id.search_news_btn:
                        selectNewsMode();
                        break;
                    case R.id.search_video_btn:
                        selectVideoMode();
                        break;
                    ...
                    case R.id.search_mic_btn:
                        if(PermissionsHelper.canAccessMicrophone(SearchActivity.this))
                            searchByMic();
                        else
                            PermissionsHelper.askMicrophonePermission(SearchActivity.this);
                        break;
    ...
    private void selectAllMode(){
        allBtn.setBackgroundResource(R.drawable.btn_red_left);
        newsBtn.setBackgroundResource(R.drawable.btn_grey_center);
        videoBtn.setBackgroundResource(R.drawable.btn_grey_right);
        allBtn.setTextColor(ContextCompat.getColor(this, R.color.app_white));
        newsBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        videoBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        selectedMode = 0;
        currentPage = 0;
        posts.clear();
        isListLoaded = false;
    ...
    private void selectNewsMode(){
        allBtn.setBackgroundResource(R.drawable.btn_grey_left);
        newsBtn.setBackgroundResource(R.drawable.btn_red_center);
        videoBtn.setBackgroundResource(R.drawable.btn_grey_right);
        allBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        newsBtn.setTextColor(ContextCompat.getColor(this, R.color.app_white));
        videoBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        selectedMode = 1;
        currentPage = 0;
        posts.clear();
    ...
    private void selectVideoMode(){
        allBtn.setBackgroundResource(R.drawable.btn_grey_left);
        newsBtn.setBackgroundResource(R.drawable.btn_grey_center);
        videoBtn.setBackgroundResource(R.drawable.btn_red_right);
        allBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        newsBtn.setTextColor(ContextCompat.getColor(this, R.color.app_black));
        videoBtn.setTextColor(ContextCompat.getColor(this, R.color.app_white));
        selectedMode = 2;
        currentPage = 0;
        posts.clear();
        isListLoaded = false;
    ...
    private void callSearchApi(){
        ...
        ApiCall.searchContent(selectedMode, searchEditText.getText().toString(), currentPage, new Callback<JsonArray>() {
            @Override
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                if(response.body()!=null && response.isSuccessful()){
                    ...
                    if(currentPage == 0) {
                        Toast.makeText(SearchActivity.this, getString(R.string.error_load_data), Toast.LENGTH_SHORT).show();
                        isListLoaded = true;
                    }
                }
                setListAdapter();
            ...
            public void onFailure(Call<JsonArray> call, Throwable t) {
                if(progressBar!=null)
                    progressBar.setVisibility(View.GONE);
                if(currentPage==0) {
                    Toast.makeText(SearchActivity.this, getString(R.string.check_internet), Toast.LENGTH_SHORT).show();
                    isListLoaded = true;
                }
                setListAdapter();
            }
    ...
    private void setListAdapter(){
        if(posts.size()>0){
            ...
            if(selectedMode == 0) {
                if (currentPage == 0) {
                    allAdapter = new NewsVidAdapter(this, posts, recyclerView);
                    recyclerView.setAdapter(allAdapter);
                    allAdapter.setOnLoadMoreListener(new NewsVidAdapter.OnLoadMoreListener() {
                        @Override
                ...
                if (currentPage == 0) {
                    videosAdapter = new Videos2Adapter(this, posts, recyclerView);
                    recyclerView.setAdapter(videosAdapter);
                    videosAdapter.setOnLoadMoreListener(new Videos2Adapter.OnLoadMoreListener() {
                        @Override
                        public void onLoadMore() {
                            if (!isListLoaded) {
                                currentPage++;
