...
import ma.snrt.news.adapter.TechAdapter;
...
public class TechFragment extends Fragment {
    ...
    private void setListAdapter(){
        if(posts.size()>0){
            ...
            if(newsPage ==0){
                TechAdapter = new TechAdapter(mContext, posts, recyclerView);
                recyclerView.setAdapter(TechAdapter);
                TechAdapter.setOnLoadMoreListener(new TechAdapter.OnLoadMoreListener() {
                    @Override
